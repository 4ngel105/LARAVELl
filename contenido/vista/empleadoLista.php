...
<div class="col-md-12"><br><br>
            <center><h1 class="text-white">LISTA DE EMPLEADOS</h1></center>
            <br><br>
                ...
                <tbody align="center" class="bg-dark text-white">
                    ...
                    <tr>
                        ...
                        <td style='text-align: center;'>
                            <a href="../controlador/empleadoModifica.php?cod=<?php echo $r[0]; ?>  " class="btn btn-success " >
                            <i class='fa-regular fa-pen-to-square'></i>
                            </a>
                            
                        </td>
                        <td>
                            <a href="../controlador/empleadoElimina.php?cod=<?php echo $r[0]; ?>" class="btn btn-danger">
            ...
            <td><a href='../controlador/empleadoRegistro.php'class="btn btn-success">Nuevo Empleado <i class="fa-solid fa-user"></i></a></td>
            <td><a href='../controlador/empleadoeBusqueda.php'class="btn btn-info">Buscar Empleado <i class="fa-solid fa-magnifying-glass"></i></a></td>
            <td><a class="btn btn-danger" align="center" href="../reportes/reporteempleado.php"><i class="fa-solid fa-file-pdf"></i></a></td>
